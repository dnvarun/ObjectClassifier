...
identify.py is the required python code.
The folder Object_Classifier contains the Keil project.

Prerequisites:
--------------
Keil mu vision MDK v5 https://www.keil.com/download/product/
...
A video explaining how to install above prerequisites and run our code can be found at: https://www.youtube.com/watch?v=CQX0AesmGE8
